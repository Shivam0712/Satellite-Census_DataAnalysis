...
### Subsetting data frame with only useful columns
df_comb=df_comb.loc[:,col]


# In[8]:

### HH amenities table variable
...
### Variable* Number of Household in Village * 0.01
for i in var:
...
### creating a dataframe with correlations
df1=pd.DataFrame()
df2=pd.DataFrame()
...
### Exporting the file with correlations
